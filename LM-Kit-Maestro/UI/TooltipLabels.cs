namespace LMKit.Maestro.UI
{
    internal static class TooltipLabels
    {
        ...
        public const string DISPLAY_SETTINGS = "Display Settings";
        public const string DISPLAY_CHATS = "Display Chats";
        public const string EJECT_MODEL = "Eject model";
        public const string SELECT_ANOTHER_FOLDER = "Select another folder";
        public const string OPEN_IN_FILE_EXPLORER = "Open in File Explorer";
    }
}